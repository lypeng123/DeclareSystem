$(function () {
	...
	function renderCaseList(data) {
		...
		// };
		theadInnerHtml = '<tr><td>用户名</td><td>密码</td><td>类型</td><td>状态</td><td>公司名称</td><td>负责人</td><td>操作</td></tr>';
		...
		if (list.length == 0) { //无符合结果
			...
			for (var i = 0; i < list.length; i++) {
				...
				// }
				//tbodyInnerHtml += '<tr' + item.user_name + '><td>' + item.password + '</td><td>' + item.type + '</td><td>' + item.state + '</td><td>' + item.company_name + '</td><td>' + item.responsible_person + '</td><td><a href="javascript:;" class="preview ' + previewSwitch + '">修改</a><span class="split">|</span><a href="' + item.file_path + '" class="download">删除</a></td></tr>';
                //tbodyInnerHtml += '<tr> <td>'+item.user_name + '</td><td>' + item.password + '</td><td>' + item.type + '</td><td>' + item.state + '</td><td>' + item.company_name + '</td><td>' + item.responsible_person + '</td><td><a href="javascript:;" class="preview ' + previewSwitch + '">修改</a><span class="split">|</span><a href="" class="download">删除</a></td></tr>';
                tbodyInnerHtml += '<tr> <td>'+item.user_name + '</td><td>' + item.password + '</td><td>' + item.type + '</td><td>' + item.state + '</td><td>' + item.company_name + '</td><td>' + item.responsible_person + '</td><td><a href="javascript:;" class="preview ' + previewSwitch + '">修改</a><span class="split">|</span><a href="" class="download">删除</a></td></tr>';
			};
